...
1. BALI 2 KOMODO CHALLENGE — 12 days, THREE DIFFERENT ROUTES
   ...
   and it is the single easiest thing to get wrong in this file — if you find yourself quoting 3,200 or 3,950,
   or offering "$550 off", you are on the OLD model and you are quoting a price that is not on the site.
   (4,300 was on that list until 27-jul-2026 and is NOT any more: with the Deluxe standard at 3,750 it is now the
   LIVE Deluxe-with-guide figure, 3,750 + 550. Quote it flat when they've taken the guide. Don't put it back on
   this list — same digits as the dead price, different meaning, and the full history is in the VERIFICATION note.)
...
- Frame it simply: "We've got three editions — Roundtrip, Extreme and Deluxe", then one plain line each (Roundtrip $2,700 loops back by road · Extreme $3,450 longest/most remote, flies you back · Deluxe $3,750 top-end with heli, massages, boutique hotels). If their form already told you their tier, skip straight to the matching one(s).
