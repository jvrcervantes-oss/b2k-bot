...
- Contact via WhatsApp, Instagram @baliepicadventures
- Website: balimotoadventures.com

MAIN TOURS:

1. BALI TO KOMODO CHALLENGE — 12 days, 4 islands, 1,259 km
   Route: Bali → Lombok → Sumbawa → Komodo
   Packages:
   - Roundtrip EUR 2,950 — best value, budget hotels, 1,458 km
   - Extreme EUR 3,650 — standard hotels, 1,826 km, harder pace
   - Deluxe EUR 3,950 — luxury hotels, 1,259 km, helicopter tour, 3 massages, support car
   ...
   Deposit: EUR 1,000 to reserve. Balance due 60 days before departure.
   Includes: luxury/standard hotels (by package), inter-island ferries, internal flights, support vehicle, expert guide, mechanic, full gear kit, all meals, fuel
   Not included: international flights, drinks, insurance (optional add-on)
   Bikes: Kawasaki Versys 250 (recommended, for 2 riders or solo >100kg) · Honda CB 150X (solo <100kg) · Kawasaki KLX 250 (offroad, on request)
   Max group: 12 motorcycles / 24 people. Dates are flexible.

2. 7 ISLANDS HOPPING — 13 days, 7 islands (Bali + Gilis + Nusas)
   Transport options (no additional modifiers):
   - Bike × 2 (shared motorcycle): EUR 1,718
   - Bike × 1 (solo motorcycle): EUR 1,787
   - Car self-drive: EUR 1,925
   - Car + driver: EUR 2,195
   Deposit: EUR 1,000. Balance due 60 days before departure.
   Insurance add-on: EUR 250 full-risk · or EUR 1,000 refundable security deposit
   Booking WhatsApp: +34 609 764 465 (Noelia)
   Focus: adventure + relaxation, turquoise waters, hidden beaches, island roads

3. SUMBA CHALLENGE — coming soon 2026
